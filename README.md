...
---
#*IMPORTANTE* se incluira ffmpeg.exe y ffprobe.exe para descargar por caso de error en el install.py


IMPORTANTE EL CMD que se abre no debe borrarse se quitara automaticamente una vez se cierre el programa
---
